...
//starting session and checking if user logged in already or not
session_start();
$signedin=false;
...
<html lang="en">
  ...
  <link rel="shortcut icon" type="x-icon" href="ABOUT\IMG\download.png" />
  ...
  <body>
    <nav class="navbar h-nav-resp background">
      <ul class="nav-list v-class-resp">
        <div class="logo"><img src="ABOUT\IMG\download.png" alt="LOGO" /></div>
...
From Google to Microsoft, LPU Students are working with top brands at packages of over Rs. 1 Crore
          ...
          <hr>
          <div class="buttons">
            <a href="signup.php" target="_blank"> <button class="btn"> ADMISSION</button></a>
           <a href="https://www.youtube.com/c/LPUOnYoutube" target="_blank" > <button class="btn">WATCH VIDEO</button></a>
          </div>
        </div>
        <div class="secondhalf">
          <img src="ABOUT\IMG\download.png" alt="LOGO" />
        </div>
      </div>
    </section>
    ...
    <section class="section boy section-left" id="Affiliation">
      ...
      <div class="thumbnail">
        <img src="https://www.collegebatch.com/static/clg-gallery/lovely-professional-university-lpu-jalandhar-20115.jpg" alt="LOGO" class="imgFluid" />
      </div>
    </section>
    <section class="contact " id="contact">
      ...
      <div class="form">
        ...
        >
Elaborate your concern</textarea
        >
    ...
    <footer class="background">
      <p class="text-footer">
        Copyright &copy; 2027 LPU.com-
        all rights are reserved    
        
      </p></footer>
<script src="ABOUT\JS\resp.js"></script>
</body>
</html>
